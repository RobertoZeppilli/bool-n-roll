<div class="container">
    <h1>{{$user->name}} qui puoi creare il tuo profilo</h1>
    ...
    <div class="card-container">
        ...
        @method('POST')
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Inserisci il nome d'arte" name="stagename" id="stagename" value="{{old('stagename')}}">
                @error('stagename')
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Default input" name="typology" id="typology">
                @error('typology')
                    <small class="text-danger">{{$message}}</small>
                @enderror
            </div>
